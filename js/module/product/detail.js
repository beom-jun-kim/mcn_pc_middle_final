...
$('.detailTab .detailNavi a').click(function(e){
    e.preventDefault();
    $('.detailContent > div').hide().filter(this.hash).fadeIn(300);
...
$(window).on('mousewheel',function(e){
    ...
    if(wheel > 0){
        $(".xans-product-additional .detailNavi").addClass('active');
    } else {
        $(".xans-product-additional .detailNavi").removeClass('active');
    }
});